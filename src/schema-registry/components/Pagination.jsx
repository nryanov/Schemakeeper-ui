...
const Pagination = ({page, maxPage, changePage}) => (
    <nav aria-label="Page navigation">
        <ul className="pagination justify-content-center">
            ...
            { page - 2 > 1 ? <li className="page-item disabled"><button type="button" className="page-link">...</button></li> : <></> }
            ...
            { page + 2 < maxPage ? <li className="page-item disabled"><button type="button" className="page-link">...</button></li> : <></>}
            { maxPage === page ? <></> : <li className={`page-item`}><button type="button" className="page-link" onClick={() => changePage(maxPage)}>{maxPage}</button></li>}
